...
const buildEmbed = () => {
  return new EmbedBuilder()
    .setTitle("Randsum")
    .setDescription(
      "RANDSUM.io is the internet's premier randum number service. Generate your own rolls with our [Dice Notation](https://github.com/RANDSUM/randsum-ts/blob/main/RANDSUM_DICE_NOTATION.md) or use some of our built-in game commands. You'll get the rolls you want - not always the results you need.",
    )
    .setFields({
      name: "/roll <notation>",
      value:
